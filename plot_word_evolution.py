...
beta = scipy.io.loadmat('./results/SLURMED/detm_un_K_50_Htheta_800_Optim_adam_Clip_0.0_ThetaAct_relu_Lr_0.001_Bsz_200_RhoSize_300_L_3_minDF_30_trainEmbeddings_1_beta.mat')['values'] ## K x T x V
print('beta: ', beta.shape)

with open('data/un/split_paragraph_0/min_df_30/timestamps.pkl', 'rb') as f:
...
## get vocab
data_file = 'data/un/split_paragraph_0/min_df_30'
...
words_1 = ['vietnam', 'pakistan', 'indonesia']
tokens_1 = [vocab.index(w) for w in words_1]
betas_1 = [beta[46, :, x] for x in tokens_1]
...
betas_11 = [beta[29, :, x] for x in tokens_11]
...
words_13 = ['nuclear', 'israel', 'military', 'america', 'iran']
tokens_13 = [vocab.index(w) for w in words_13]
betas_13 = [beta[29, :, x] for x in tokens_13]
...
ax4.set_title('Topic "Middle East"', fontsize=12)
...
betas_49 = [beta[48, :, x] for x in tokens_49]
