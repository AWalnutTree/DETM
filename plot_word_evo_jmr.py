...
## get vocab
data_file = 'data/JMR/split_paragraph_False/min_df_10' #MODIFICATION 'un' -> 'data/un/split_paragraph_1'
...
ax1.set_title('Topic "Food & Food Stamps"', fontsize=12)
...
ax2.set_title('Topic "Online Commerce"', fontsize=12)
