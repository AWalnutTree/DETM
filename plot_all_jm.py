...
# Load the timelist
with open('data/JM/split_paragraph_False/min_df_10/timestamps.pkl', 'rb') as f:
...
shift_value = 1936  # Change this to whatever shift you want
...
plt.tight_layout()
plt.savefig('word_evolution_jm_all.png')
plt.show()